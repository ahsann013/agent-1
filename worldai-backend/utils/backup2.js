...
try{
    ...
    // Create a transform stream to handle the streaming
      ...
      async start(controller) {
        for await (const chunk of stream) {
          ...
          if (contentChunk) {
            ...
            // Send chunks as they arrive (you might want to debounce this)
            controller.enqueue(contentChunk);
          }
        }
  
        // Process final message after stream completes
        finalMessage = buffer;
        ...
        // Enqueue final structured response
