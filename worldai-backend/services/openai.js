...
export class AppServiceOpenAI {
    ...
    getSystemPrompt() {
        ...
        // Hardcoded part for function analysis and tool selection
  ...
  3. Always ensure the response is returned as a well-formed JSON object with the specified fields.
    `;
        ...
        // Combine both prompts: the dynamic one from the database and the hardcoded prompt
...
const tools = [
    ...
    async runAgent(message, fileInfo = null, userId) {
        ...
        // Get the final system prompt by merging dynamic and hardcoded prompts
        let systemPrompt = this.getSystemPrompt();

        // Add the file URL to the system prompt if available
        ...
        try {
            ...
            // First message to get the tool selection
            ...
            if (initialResponse.tool_calls && initialResponse.tool_calls.length > 0) {
                ...
                for (const toolCall of initialResponse.tool_calls) {
                    // Handle both new and old tool call structures
                    ...
                    // Handle both argument structures
                    ...
                    // Capture image or video URLs if generated
                ...
                // Second call to get the final response after tool calls
            ...
            // Ensure all required fields exist and add tool results
